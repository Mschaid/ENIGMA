...
#TODO save processor to pickle - make 

'''
check if dir exists, if not, make new dir
store object in that dir
'''        
    def save_processor(self):

        dir = os.path.dirname(self.path_to_processed_data)
